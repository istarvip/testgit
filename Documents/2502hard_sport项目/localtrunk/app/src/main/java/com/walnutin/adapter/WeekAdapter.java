...
public class WeekAdapter extends BaseAdapter {
    ...
    public WeekAdapter(Context context, List<Week> l) {
    ...
    public void setWeekList(List<Week>d){
        weekList = d;
    ...
    public void setPositionClicked(int positio){
        ...
        EventBus.getDefault().post(new StepChangeNotify.WeekDayPostion(positio));
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
     ...
     //   System.out.println(" weekAdapter........."+week.day);
        ...
        hoder.weeInfo.setText(weekString[i]);
