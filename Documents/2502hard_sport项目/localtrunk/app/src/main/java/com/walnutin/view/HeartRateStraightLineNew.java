 ...
 */
public class HeartRateStraightLineNew extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public HeartRateStraightLineNew(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
