...
public class ServiceUUIDParser {
...
//    }
    ...
    public static String decodeLocalName(byte[] data, int start, int length) {
        try {
            ...
            Log.d("ScannerServiceParser", "Unable to convert the complete local name to UTF-8", var4);
            return null;
        } catch (IndexOutOfBoundsException var5) {
            Log.d("ScannerServiceParser", "Error when reading complete local name", var5);
            return null;
        }
    }
