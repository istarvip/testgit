 ...
 */
public class WalnutinDb extends SQLiteOpenHelper {
    private static String db_name = "db_hch";
    private static int db_version = 1;
    private static WalnutinDb instance;
    ...
    public static WalnutinDb getInstance() {
        if (instance == null) {
            instance = new WalnutinDb(HardSdk.getInstance().getContext());
        }
        return instance;
    }

    public static void destory() {
        WalnutinDb.instance = null;
    }

    public WalnutinDb(Context context) {
    ...
    static public void insertOrUpdateHeartRate(String date, String heartRate) {
        SQLiteDatabase db = WalnutinDb.getInstance().getWritableDatabase();
        String sql = "";
    ...
    public static List<String> getHeartRateDataByDate(String date) {
        ...
        SQLiteDatabase db = WalnutinDb.getInstance().getReadableDatabase();
        Cursor cursor = db.rawQuery(sql, null);
