...
//            String reslut = DigitalTrans.getResultCommandWalnutin("a60e000701010203040506");  //喝水提醒
            String reslut = DigitalTrans.getResultCommandWalnutin("befe444655010200f002");  //喝水提醒
//            String reslut = DigitalTrans.getResultCommandWalnutin("A60400101F08007F09007F0A007F0C00000F0001");//闹钟
//            String reslut = DigitalTrans.getResultCommandWalnutin("A60400101F00257F09007F0A007F0C00000F0001");
//            String reslut = DigitalTrans.getResultCommandWalnutin("A60300050100170019");//睡眠闹钟
//            String reslut = DigitalTrans.getResultCommandWalnutin("A603000501173B1731");
//            String reslut = DigitalTrans.getResultCommandWalnutin("A602000E0042681b581E011B580027100800A418");
//            String reslut = DigitalTrans.getResultCommandWalnutin("A601000B00001007E1081703080100D518");
            Log.d(TAG, "sendRateTestCommand: reslut:"+reslut);
            bluetoothLeService.writeRXCharacteristic(DigitalTrans.hex2byte(reslut));

        } else if (status == GlobalValue.RATE_STOP) {
            String reslut = DigitalTrans.getResultCommandWalnutin("A618000100");
            bluetoothLeService.writeRXCharacteristic(DigitalTrans.hex2byte(reslut));
        }
    }
