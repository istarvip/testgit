...
public class DataProcessing implements IDataProcessing {
    ...
    private void dealHeartData(String bufferData) {
        ...
        WalnutinDb.insertOrUpdateHeartRate(sf, serialString + data); // 添加原始心率数据以及包号到数据库
    ...
    private void dealSleep(String bufferData) {
        ...
        WalnutinDb.insertOrUpdate(date, data);

        String beforeData = WalnutinDb.getSleepDataByDate(beforeOneDate);
